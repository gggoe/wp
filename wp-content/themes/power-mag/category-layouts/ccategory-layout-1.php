<?php
/**
 * Template part for displaying category layout 1.
 *
...
{
    $character_title_count = 30;
    $character_content_count = 40;
    $cat_no_sidebar = 'cat-layout1-no-sidebar';
}
else
{
    $character_title_count = 25;
	                        ...
	                        <span class="post_date">
	                            ...
	                            printf( 
                                    /* translators: %1$s : description of url */
                                     ...
                                     /* translators: %2$s : description of published date */
