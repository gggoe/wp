...
add_action('widgets_init', 'power_mag_register_one_column_layout_1_widget');

function power_mag_register_one_column_layout_1_widget() {
    register_widget('Power_mag_one_column_layout_1');
}
 ...
 */
class Power_Mag_One_Column_Layout_1 extends WP_Widget {
    
	function __construct() {
		$widget_ops = array( 
			'classname' => 'power_mag_one_column_layout_1', 
			'description' =>__('Best for Home Page Middle Left and Right Content Area', 'power-mag') 
		);
		
		parent::__construct('power_mag_one_column_layout_1', __('&nbsp;PM - One Column Layout 1 Widget', 'power-mag'), $widget_ops);
	}
    ...
    function widget($args, $instance) {
        ...
        if ($lt->have_posts()) { 
            ...
            ?> 
			<div class="widget_one_column_layout_1_container ">
            
            <div class="one_column_layout_1_title_wrapper widget_title_wrapper wow fadeIn">
            ...
            while ($lt->have_posts()) : $lt->the_post();
                ?>
                <div class="one_column_layout_1_thumbnail_wrapper wow fadeIn">
                <?php
                ...
                if (has_post_thumbnail()) {
                    ?>
                    <div class="one_column_layout_1_thumbnail_big">
                        <?php
                        ...
                        ?>
                        <div class="pm_one_column_layout_1_cat_wrapper">
                    ...
                    <?php
                        ...
                        <div class="one_column_layout_1_thumbnail_big">
                            <img src="<?php echo esc_url(POWERMAG_IMAGES_URL . '/426into220.png') ; ?>" alt="<?php the_title_attribute(); ?>" title="<?php the_title_attribute(); ?>" />
                            <div class="pm_one_column_layout_1_cat_wrapper">
                                <div class="category_lists">
                                    <?php power_mag_colored_category(); ?>
                                </div>
                    ...
                    if (has_post_thumbnail() ) {
                    ?>
                    <div class="one_column_layout_1_thumbnail_small">
                        <?php
                    ...
                    <div class="one_column_layout_1_info_wrapper <?php echo esc_html($count == 1)? 'one_column_layout_1_first_info_wrapper': ''; ?>">
                        
                        <div class="pm_one_column_layout_1_title">
                        ...
                        <?php if($count == 1): ?>
                        <div class="column_one_layout_1_content">
                            <?php
                                power_mag_add_excerpt_length( apply_filters( 'power_mag_service_excerpt_length', absint(30)) );
                                the_excerpt();
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')) ; ?>"><?php esc_html_e('Title', 'power-mag'); ?>:<br />
                <input class="widefat" id="<?php esc_attr($this->get_field_id('title')) ; ?>" name="<?php echo esc_attr($this->get_field_name('title')) ; ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p>
